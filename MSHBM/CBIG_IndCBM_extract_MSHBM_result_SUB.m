function CBIG_IndCBM_extract_MSHBM_result_SUB(project_dir,SUB)

% CBIG_IndCBM_extract_MSHBM_result_JDNSG(project_dir)
...
% Slightly modified by Jingnan Du to include subject ID in the .mat output filename 
...
for i = 1:sub_num
    ...
    output_file = fullfile(output_dir, ['Ind_parcellation_MSHBM_sub' num2str(i) '_' SUB{i} '.mat']);
